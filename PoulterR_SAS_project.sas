...
DATE: Thursday, January 08, 2015     TIME: 11:24:23 AM
PROJECT: PoulterR_SAS_project_010815.sas
PROJECT PATH: P:\QAC\qac200\students\rpoulter\Assignments\PoulterR_SAS_project_010815.sas.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\rpoulter\Assignments\PoulterR_SAS_project_010815.sas.egp';
%LET _CLIENTPROJECTNAME='PoulterR_SAS_project_010815.sas.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 11:24:15 AM
...
PROC SQL;
   ...
   SELECT t1.DUPERSID, 
          ...
          t1.INSAT12X, 
          t1.INSCOV12
      FROM EC100037.meps_fullyr_2012 t1
      WHERE t1.AGE12X >= 18;
QUIT;
